...
const Contact = () => {
  ...
  return (
    <section className={'h-module-medium py-36 px-36'}>
      <div className="w-1/2">
        <SectionTitle sectionTitle="Let's talk." sectionVariant={true}/>
        <p className="w-5/6 py-8 font-lato  tracking-wide font-light text-lg">
        ...
        <p className="w-5/6 font-lato tracking-wide font-light text-lg">
