import ActiveCircle from "./basics/PaginationCircle"
    ...
    <>
      <div className="flex gap-2 xl:gap-12 w-full h-full items-center justify-center xl:basis-1/3 flex-wrap">
        <div onClick={() => props.handlePrevProject()}>
          <img src="https://cdn-icons-png.flaticon.com/512/9229/9229001.png" alt="prev" className="w-10 h-10 rotate-180 dark:invert" />
        </div>
        <ProjectCard projects={props.projects} projectIndShown={props.projectIndShown} />
        <div onClick={() => props.handleNextProject()}>
          <img src="https://cdn-icons-png.flaticon.com/512/9229/9229001.png" alt="next" className="w-10 h-10 dark:invert" />
        </div>
      </div>
