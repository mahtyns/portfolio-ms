...
const MainOrbits = () => {
    ...
    return (
        <div className={`w-full -pt-24 pb-12 ${flex} overflow-hidden flex-col`}>
            <div className={`${orbit} ${flex} w-[600px] h-[600px] border border-gray-100 `}>
                <div className={`${orbit} ${flex} w-[480px] h-[480px] border border-gray-100`}>
                    <div className={`${orbit} ${flex} w-[450px] h-[450px] border border-gray-200 before:bg-special-500 before:w-2 before:h-2 before:rounded-full before:absolute before:transform before:translate-y-64 animate-spin`}>
