        ...
        <div className={`w-full py-16 ${flex} overflow-hidden flex-col`}>
            <div className={`${orbit} ${flex} w-[700px] h-[700px] border border-gray-100 `}>
                <div className={`${orbit} ${flex} w-[600px] h-[600px] border border-gray-100`}>
                    <div className={`${orbit} ${flex} w-[550px] h-[550px] border border-gray-200 before:bg-gray-400 before:w-2 before:h-2 before:rounded-full before:absolute before:transform before:translate-y-64 animate-spin`}>
